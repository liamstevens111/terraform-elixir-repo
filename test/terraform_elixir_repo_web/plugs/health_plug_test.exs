defmodule TerraformElixirRepoWeb.HealthPlugTest do
  use TerraformElixirRepoWeb.ConnCase, async: true

  import ExUnit.CaptureLog

  alias TerraformElixirRepoWeb.HealthPlug
  ...
  describe "call/2" do
    ...
    test "given the database is not ready, returns 500 internal server error " do
      expect(Ecto.Adapters.SQL, :query, fn TerraformElixirRepo.Repo, "SELECT 1" ->
